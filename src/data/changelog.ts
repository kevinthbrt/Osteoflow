...
export const changelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'improvement', text: "Le simulateur convertit les consultations en recettes à partir de votre tarif moyen et de vos semaines travaillées, tels que définis dans Objectifs : les deux pages parlent de la même activité." },
