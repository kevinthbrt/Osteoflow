...
export const changelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'improvement', text: "L'ancienne dictée disparaît du formulaire, ainsi que le bouton « Mode consultation » de la fiche patient. Il n'y a plus qu'un chemin : « Nouvelle consultation », puis le mode consultation depuis la section Anamnèse. Les deux fonctions que l'ancienne dictée portait seule sont conservées : la détection des informations du dossier, qui garde son panneau de validation un champ à la fois, et le dépistage des drapeaux rouges sur la dictée complète." },
      { type: 'feature', text: "Second dépistage des drapeaux rouges à la fin de l'anamnèse, sur la dictée entière. L'analyse au fil de la parole ne voit qu'un passage à la fois : un signe qui ne se déduit que du recoupement de deux phrases éloignées pouvait lui échapper. Ce second passage reprend le dépistage complet, le plus détaillé, et n'ajoute que ce qu'il retrouve en plus. Un drapeau rattrapé annule toujours un « aucun identifié » et vous est signalé, entre une case cochée et un signe présent c'est le signe qui l'emporte." },
      { type: 'fix', text: "Le dépistage en direct couvrait bien les mêmes dix familles de signaux que l'ancienne structuration, mais sa version abrégée avait perdu une dizaine de signes en chemin : réveils douloureux, altération de l'état général, paresthésies progressives, syndrome de la queue de cheval, suspicion de fracture, palpitations, céphalée en coup de tonnerre, vertiges, toxicomanie intraveineuse, et les bornes d'âge chiffrées. Les listes sont réalignées, y compris celle affichée dans le pense-bête." },
      { type: 'improvement', text: "Une consultation, un seul écran. Le mode consultation ne vit plus sur une page à part : il s'ouvre par-dessus le formulaire de consultation, depuis un bouton en tête de la section Anamnèse, et se referme dessus. Rien n'est perdu en l'ouvrant, rien n'est à recharger en le fermant, et ce que vous aviez déjà saisi dans le formulaire reste intact. Le bouton « Mode consultation » de la fiche patient mène exactement au même endroit." },
      { type: 'improvement', text: "Un seul brouillon, tenu par le formulaire. L'anamnèse en cours du mode consultation y est enregistrée avec le reste de la consultation, au lieu d'être écrite en parallèle : les deux se seraient écrasés, celui du mode consultation ne connaissant ni l'examen ni les conseils déjà saisis. À la réouverture, le bouton indique combien d'éléments sont déjà relevés et propose de reprendre." },
      { type: 'improvement', text: "Les symboles des rubriques retrouvent leur couleur, dans le fil comme dans le pense-bête : ils se repèrent d'un coup d'œil au lieu de se lire. La couleur du texte, elle, reste réservée au drapeau rouge et au terme incertain." },
      { type: 'improvement', text: "Colonne de gauche plus vivante : pastille d'initiales colorée, profession et sport en étiquettes, antécédents distingués par une couleur selon leur nature, consultations passées marquées d'un filet coloré. Cette colonne est du matériel de référence qu'on balaye du regard, la teinte y sert à retrouver une rubrique et n'entre pas en concurrence avec le rouge du drapeau, qui reste le seul signal du centre." },
      { type: 'improvement', text: "Refonte visuelle de l'écran. Du relief entre les colonnes : le fil central est posé sur la surface haute du thème avec une ombre douce, les deux panneaux latéraux passent en creux. On voit d'un coup d'œil où est le contenu et où est le contexte, ce qui n'était pas le cas quand les trois colonnes partageaient la même teinte." },
      { type: 'improvement', text: "Les symboles en tête de ligne sont désormais de vraies icônes, de même épaisseur de trait et de même gris que le texte. Les emoji avaient chacun leur palette et leur graisse, changeaient de dessin selon le système et juraient avec le reste de l'application. La couleur reste réservée au drapeau rouge et au terme incertain." },
      { type: 'improvement', text: "Une hiérarchie de lecture, par la taille plutôt que par la couleur : le motif devient le titre de la consultation, détaché en tête du fil ; les faits gagnent en corps et en interligne ; le verbatim se retire. Le fil est aussi borné en largeur, des lignes qui courent d'un bord à l'autre d'un grand écran se lisant mal." },
      { type: 'improvement', text: "Au démarrage, le micro devient le centre de l'écran au lieu d'un petit bouton dans un coin : à ce moment il n'y a qu'une chose à faire. Il redevient discret dans l'en-tête une fois la dictée lancée." },
      { type: 'improvement', text: "Une barre de progression de deux pixels au bas de l'en-tête montre la part de l'interrogatoire couverte. Sur dix minutes, rien n'indiquait qu'on avançait." },
      { type: 'improvement', text: "Pied de page allégé : le décompte des éléments relevés disparaît, vous les avez sous les yeux. La mention de prudence du copilote quitte le bas de la colonne, où elle occupait quatre lignes en permanence, pour une infobulle sur son titre." },
      { type: 'feature', text: "Nouvelle colonne de gauche : le dossier du patient sous les yeux pendant l'interrogatoire. Son âge, sa profession, son sport ; ses points de vigilance mis en avant, parce que ce sont eux qui peuvent changer la conduite de la séance et qu'ils ne doivent pas se chercher ; ses antécédents groupés par nature ; et ses huit dernières consultations avec leur motif et leur phrase de synthèse. En lecture seule : pendant que le patient est là, on consulte, on ne saisit pas. La colonne s'escamote d'un bouton dans l'en-tête." },
      { type: 'improvement', text: "Les lignes apparaissent au rythme de la parole. L'envoi ne se fait plus à intervalle fixe mais dès que la phrase est finie, avec un plafond d'attente pour un patient qui enchaîne sans respirer. C'est plus fluide à l'écran et cela déclenche moins d'appels qu'un tic-tac régulier. Dans l'application de bureau, les segments audio passent de quinze à dix secondes, plancher en dessous duquel la transcription se dégrade plus qu'elle n'accélère." },
      { type: 'improvement', text: "Une phrase qui répond à plusieurs rubriques les renseigne toutes. « J'ai mal en plein milieu des lombaires » remplit désormais la localisation ET la latéralité, une douleur centrale étant une réponse de latéralité et non une absence de réponse. Un axe réclamé à tort vous faisait reposer une question déjà posée." },
      { type: 'feature', text: "Un axe sans objet pour ce patient s'écarte d'un clic dans le copilote, et se rétablit aussi facilement. Sans cette porte de sortie, une rubrique qui ne s'applique pas restait réclamée indéfiniment et le pense-bête devenait un bruit de fond qu'on cesse de lire." },
      { type: 'feature', text: "Brouillon conservé pendant le mode consultation. L'anamnèse en cours est enregistrée en continu, et immédiatement au verrouillage de l'écran : une anamnèse recueillie puis perdue serait pire que pas d'anamnèse du tout, le patient est reparti et on ne la refait pas. À la réouverture, elle est restaurée avec un bouton pour repartir de zéro. C'est le même brouillon que celui du formulaire, si bien qu'une reprise fonctionne des deux côtés." },
      { type: 'feature', text: "Ajout d'un élément à la main, sans dictée : une rubrique à choisir, du texte, Entrée. Le micro n'est plus le seul chemin, et une ligne saisie par vos soins est verrouillée d'emblée, l'IA n'y revient pas." },
