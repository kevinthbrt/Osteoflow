...
export const changelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'improvement', text: "Le calcul des cotisations a été confronté à l'échéancier Urssaf 2026 établi par un cabinet d'expertise comptable sur un dossier réel : les huit lignes et le total correspondent à l'euro près. Ce cas est désormais figé comme test de non-régression." },
