...
export const changelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'feature', text: "Frais de véhicule au barème kilométrique officiel : indiquez le type de véhicule, sa puissance fiscale (champ P.6 de la carte grise) et vos kilomètres professionnels, le montant déductible est calculé automatiquement. Voitures, motos et cyclomoteurs sont couverts, avec la majoration de 20 % pour les véhicules électriques." },
      { type: 'improvement', text: "Garde-fou sur le véhicule : si vous choisissez le barème kilométrique tout en saisissant des charges « Véhicule et déplacements », l'application vous alerte. Le barème couvre déjà carburant, entretien, assurance et dépréciation — les déduire en plus est un redressement assuré. Seuls péages, stationnement et intérêts d'emprunt se déduisent à part." },
      { type: 'feature', text: "Cotisations facultatives Madelin et PER : saisissez vos versements retraite et prévoyance, l'application calcule votre plafond de déduction, la fraction éventuellement non déductible, et l'économie d'impôt réellement obtenue — donc le coût net de votre effort d'épargne." },
      { type: 'improvement', text: "Point important rendu explicite : ces versements réduisent votre impôt mais pas vos cotisations Urssaf, celles-ci étant calculées sur un revenu qui les réintègre. En micro-BNC, l'abattement de 34 % étant réputé couvrir toutes vos charges, ni le barème kilométrique ni la prévoyance Madelin ne se déduisent en plus : l'application vous le signale au lieu de gonfler l'estimation." },
      { type: 'feature', text: "Deux modes de saisie au choix. En mode « Simplifié », vous entrez vos grandes masses annuelles comme sur un prévisionnel comptable — rapide et suffisant pour provisionner. En mode « Détaillé », le calcul s'appuie sur les charges saisies ligne par ligne dans l'onglet Charges." },
      ...
      { type: 'fix', text: "Correction majeure du calcul en cours d'année : l'estimation soustrayait des charges annuelles de recettes de quelques mois, et appliquait le barème progressif de l'impôt à ce revenu partiel — la provision d'impôt en ressortait dérisoire et la rémunération conseillée était faussée. Le calcul se fait désormais sur l'année entière (recettes projetées au rythme constaté, comme sur un prévisionnel comptable), puis se décline en mensuel." },
      { type: 'fix', text: "Le détail « Du chiffre d'affaires à votre poche » somme désormais exactement au disponible : chaque ligne est une vraie entrée ou sortie d'argent. Le barème kilométrique et les forfaits, qui étaient à la fois inclus dans les charges et affichés en lignes séparées, sont maintenant présentés à part comme déductions sans décaissement." },
      { type: 'feature', text: "Ma rémunération s'ouvre sur une vue « Ce mois-ci » : les encaissements du mois choisi (le mois en cours par défaut, tout mois écoulé au choix), les provisions à mettre de côté au taux annuel, la part mensuelle des charges, et ce qu'il reste à vous verser. Un bouton bascule vers la vue « Année » avec la projection complète." },
      ...
      { type: 'feature', text: "Gestion des immobilisations et de leur amortissement : table de soin, matériel médical, mobilier, informatique, agencements, véhicule. Chaque bien est étalé sur sa durée d'usage, avec un plan d'amortissement calculé au prorata depuis la mise en service, une barre de progression et le montant restant à amortir. Les durées et la TVA sont pré-remplies selon la nature du bien." },
      { type: 'improvement', text: "Distinction essentielle prise en compte : l'achat d'un bien durable sort de la trésorerie en totalité l'année de l'acquisition, mais ne se déduit que par fractions annuelles. L'application traite donc les deux mouvements séparément — le choc de trésorerie l'année de l'achat, la déduction étalée ensuite — au lieu de confondre les deux." },
      { type: 'feature', text: "Simulateur « Et si mon activité changeait ? » dans Ma rémunération : faites varier votre chiffre d'affaires ou votre nombre de consultations par semaine, et voyez en temps réel l'effet sur votre rémunération nette, vos cotisations et votre impôt — tout est recalculé instantanément, y compris les effets de seuil. L'application indique aussi combien vous conservez réellement sur chaque euro gagné en plus." },
      { type: 'improvement', text: "Le simulateur convertit les consultations en recettes à partir de votre panier moyen RÉEL — vos encaissements divisés par le nombre de consultations facturées cette année — et non d'un tarif théorique. L'origine du montant est affichée, avec le nombre de consultations sur lequel il repose. À défaut d'historique, le tarif de référence d'Objectifs prend le relais, et l'application le signale." },
      { type: 'improvement', text: "Le simulateur affiche l'effet sur le chiffre d'affaires annuel dans les deux modes : montant actuel, montant simulé, écart annuel et mensuel. Plus besoin de changer d'onglet pour savoir ce que représentent deux consultations de plus par semaine." },
      { type: 'fix', text: "Garde-fous ajoutés entre mode simplifié et données détaillées : si vous saisissez une dotation aux amortissements annuelle alors que des immobilisations sont enregistrées, l'application signale que le plan détaillé fait foi et que votre montant est ignoré. De même, le barème kilométrique en mode simplifié rappelle désormais que carburant et entretien ne doivent pas figurer dans vos charges annuelles — cet avertissement ne s'affichait qu'en mode détaillé." },
      { type: 'improvement', text: "Un avertissement s'affiche si vous saisissez un bien de moins de 500 € HT en immobilisation : sous ce seuil, le passer directement en charge est plus avantageux, la déduction étant immédiate. En mode simplifié, un champ « dotation aux amortissements » permet de reprendre directement le montant annuel de votre prévisionnel." },
    ],
  },
  {
    version: '1.15.2',
