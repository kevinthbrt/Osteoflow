...
import { TreeState, initialState, DiagnosisResult, buildResult, assessLumbarFracture, assessLumbarNeoplasia, assessLumbarInfection } from '@/lib/reasoning/legacy/lumbar-tree'
        ...
        return (
          ...
          >
            ...
            <Button className="w-full mt-3" onClick={() => {
              ...
              const traumaNeuro = q2Checks.includes('trauma') && q2Checks.includes('neuro')
              if (assessLumbarFracture(q2Checks) === 'alert') push('alert_fracture', { q2_fracture: 'yes', q2_trauma_neuro: traumaNeuro, q2_factors: factors, q2_checks: q2Checks })
        ...
        return (
          ...
          >
            ...
            <Button className="w-full mt-3" onClick={() => {
              ...
              const verdict = assessLumbarNeoplasia(q3Checks)
              if (verdict === 'alert') {
        ...
        return (
          ...
          >
            ...
            <Button className="w-full mt-3" onClick={() => {
              ...
              if (assessLumbarInfection(q4Checks) === 'alert') push('alert_infection', { q4_infection: 'yes', q4_factors: factors, q4_checks: q4Checks })
